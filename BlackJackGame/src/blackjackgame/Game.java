...
public class Game {
    ...
    public void startGame() {
        ...
        //Shows player's hand and dealer's hand with one card faced down
        System.out.println("Player's hand: " + player.getHand());
        System.out.println("Dealer's hand: [hidden], " + dealer.getHand().getCardsInHand().get(1));
        
        // Check if Player has Blackjack and end game if they do
        ...
        //Check if dealer has blackjack and end game
    ...
    //Main logic that starts the game
